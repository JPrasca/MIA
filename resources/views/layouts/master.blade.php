...
<body class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu preload-transitions 2-columns   " data-open="click" data-menu="vertical-modern-menu" data-col="2-columns">
            ...
            <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-45deg-indigo-purple no-shadow">
                <div class="nav-wrapper">
                    ...
                    <ul class="navbar-list right">
                        ...
                        <li>
                            <a id="avatar-a" style="padding-bottom: 18px; padding-top:2px; height: 65px" class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);" data-target="profile-dropdown">
                                <span class="avatar-status avatar-online">
                                    <img src="app-assets/images/avatar/avatar-7.png" alt="avatar">
                                    <i id="avatar-i" style="top: 42%;"></i>
                                </span>
                            </a>
                        </li>
                     </ul>
    ...
    <footer class="page-footer footer footer-static footer-dark gradient-45deg-indigo-purple gradient-shadow navbar-border navbar-shadow">
        <div class="footer-copyright">
            <div class="container"><span class="right">{{ config('constants.dataYear') }} Desarrollado por <a href="#">{{ config('constants.author') }}</a></span></div>
        </div>
    </footer>
